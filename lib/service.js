...
function getProducts() {
    const products = fs_1.default.readFileSync(__dirname + "/../database.json", {
        encoding: "utf8",
        flag: "r",
    });
...
function addProduct(newProduct) {
    const data = fs_1.default.readFileSync(__dirname + "/../database.json", {
        encoding: "utf8",
        flag: "r",
    });
    ...
    newProduct.productId = String(+products[products.length - 1].productId + 1);
